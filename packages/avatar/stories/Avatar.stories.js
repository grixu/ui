...
export default {
  ...
  argTypes: {
    ...
    img: {
      ...
      description: "Avatar's URL - just it. But if you not provide URL, you should provide alternative text, to generate initials on avatar"
    },
    default: {
      name: 'Default Slot',
      table: {
      ...
      description: "If you don't pass either url or text, component just show icon. Of course it's adjustable - by this slot you can provide your own icon."
    },
    onClick: {
      name: 'On click event',
      action: 'click',
